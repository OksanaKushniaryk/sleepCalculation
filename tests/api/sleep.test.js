...
function compareMetricsWithTolerance(finalResult, firstDay) {
    ...
    Object.keys(expectedValues).forEach(metric => {
        ...
        if (actual && actual.value !== null && expected && expected.value !== null) {
            ...
            // Use precision tolerance - from env SLEEP_SCORE_COMPARE_TOLERANCE variable or 0.1 (1 decimal place) for all metrics
            const tolerance = process.env.SLEEP_SCORE_COMPARE_TOLERANCE || 0.1;
